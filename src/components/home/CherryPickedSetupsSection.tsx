...
export function CherryPickedSetupsSection() {
  ...
  return (
    <div className={`sec relative ${selectedImage ? 'z-[99999]' : 'z-10'}`} id="setups">
      ...
      <div className="mk relative z-10">
        <div className="sec-head center mb-12">
          ...
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-display uppercase tracking-tighter mt-3">
            ...
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-[var(--neon)] to-emerald-400 drop-shadow-[0_0_15px_var(--neon-dim)] pb-2 pr-2 inline-block">Setups</span>
          </h2>
        ...
        <AnimatePresence>
          {selectedImage && (
            <motion.div 
              ...
              animate={{ opacity: 1 }}
              exit={{ opacity: 0 }}
              className="fixed inset-0 z-[999999] flex items-center justify-center p-4 sm:p-8 bg-black/90 backdrop-blur-2xl"
