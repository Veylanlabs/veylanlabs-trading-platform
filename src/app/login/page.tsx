  ...
  return (
    <div className="min-h-screen flex flex-col bg-background text-foreground transition-colors duration-500 font-sans selection:bg-[var(--neon)] selection:text-white relative overflow-hidden">
      ...
      <div className="flex-1 flex flex-col items-center justify-center p-6 relative z-10">
        ...
        {/* Login Card */}
        <div className="w-full max-w-md glass-panel rounded-3xl p-8 sm:p-12 relative overflow-hidden shadow-2xl shadow-[var(--neon-dim)] group">
          {/* Subtle top glow */}
          ...
          <div className="flex flex-col items-center text-center mb-8">
            ...
            <h1 className="text-3xl font-extrabold tracking-tight mb-2 text-foreground">Terminal Access</h1>
            <p className="text-muted-foreground font-medium text-sm">Initialize deployment protocol.</p>
          </div>
            ...
            <SignIn 
              ...
              appearance={{
                ...
                elements: {
                  ...
                  formButtonPrimary: "w-full py-3.5 rounded-xl bg-foreground text-background !text-background font-bold hover:opacity-90 transition-opacity mt-2 shadow-lg [&>span]:text-background",
